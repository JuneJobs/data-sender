    ...
    get_generated_tuples = (cb, parents) => {
        ...
        let lat = Number(128.679356),
            ...
            fs.readFile('data.txt', 'utf8', function(error, data) {
                ...
                pm10 = air_data.pm10;
                let tuples = [
                    [timestamp-2, 0, 0, 0, 0, pm25, pm10, 0, 0, 0, 0, pm25_aqi_calculator(pm25), pm10_aqi_calculator(pm10), 1, lat, lng],
                    [timestamp-1, 0, 0, 0, 0, pm25, pm10, 0, 0, 0, 0, pm25_aqi_calculator(pm25), pm10_aqi_calculator(pm10), 0],
                    [timestamp-0, 0, 0, 0, 0, pm10, pm10, 0, 0, 0, 0, pm25_aqi_calculator(pm25), pm10_aqi_calculator(pm10), 0],
                ];
                cb(tuples);
            });
    }
